...
public class InstructorLoginController {
	...
	public String login(@ModelAttribute instructorLoginVO ilVO, HttpSession session, Model model) {
		if (loginService.validateLogin(ilVO)) {
			session.setAttribute("inst_id", ilVO.getId());
