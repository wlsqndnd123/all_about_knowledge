...
public class ExamDomain {
	...
	private String  SUB_CODE,CONTENT,EX_1,EX_2,EX_3,EX_4;
	private int Q_NO;
	
	
	
	public ExamDomain(String sUB_CODE, String cONTENT, String eX_1, String eX_2, String eX_3, String eX_4, int q_NO) {
		super();
