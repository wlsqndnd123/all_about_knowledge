...
<!--jQuery CDN 끝-->
	...
	<!-- Bootstrap CSS -->
	<link href="http://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/css/bootstrap.min.css" rel="stylesheet" crossorigin="anonymous"> 
	...
	<div id="wrapper">
	 ...
	 <div id="content-wrapper" class="d-flex flex-column">
       ...
       <div id="content">
	    ...
	    <form action="http://localhost/all_about_knowledge/instructor/lectureManage/lectureApply_result.do" id="openLec" method="post" enctype="multipart/form-data">
	    ...
	    <!-- 강의 상세내용 -->
		    ...
		    <label style=" margin-top:10px; margin-bottom: 20px;">강의목차</label>
		            ...
		            <div class="form-group d-flex align-items-center mb-3">
		                ...
		                <input type="file" name="upfile" id="upfile" class="form-control" aria-describedby="fileNm">
		            </div>
		            <!-- 버튼 -->
