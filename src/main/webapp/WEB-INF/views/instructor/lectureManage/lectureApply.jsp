...
<body id="page-top">
	...
	<div id="apply_info" class="d-flex flex-column mt-3"> <!-- apply_info -->
	    ...
	    <div id="label_group" class="d-flex flex-row justify-content-center" >
	       ...
	       <div id="lec_detail" style="flex-direction: column;"> <!-- 강의상세 입력 -->
		    <div class="input-group mb-3">
			  <span class="input-group-text" id="basic-addon1">강의명</span>
			  <input type="text" class="form-control" placeholder="강의명을 입력해주세요" aria-label="Username" aria-describedby="basic-addon1">
			</div>
		    <div class="input-group mb-3">
			  <span class="input-group-text" id="basic-addon1">학습개요</span>
			  <input type="text" class="form-control" placeholder="학습개요를 입력해주세요" aria-label="Username" aria-describedby="basic-addon1">
			</div>
		    <div class="input-group mb-3">
			  <span class="input-group-text" id="basic-addon1">학습목표</span>
			  <input type="text" class="form-control" placeholder="학습목표를 입력해주세요" aria-label="Username" aria-describedby="basic-addon1">
			</div>
		    <div class="input-group mb-3">
			  <span class="input-group-text" id="basic-addon1">강의이미지</span>
			  <input type="file" class="form-control" aria-label="Username" aria-describedby="basic-addon1">
			</div>
			<div class="input-group mb-3">
			  <span class="input-group-text" id="basic-addon1">총 차시 수</span>
			  <input type="text"  class="form-control" value="8개" readonly aria-describedby="basic-addon1" >
			</div>
			<div class="input-group mb-3">
			  <span class="input-group-text" id="basic-addon1">개설일자</span>
			  <input type="datetime-local"  class="form-control"  aria-describedby="basic-addon1">
			</div>
		<!-- </div> -->
		
	    <!-- <div id="lec_lesson" style="flex-direction: column;"> --> <!-- 강의차시 입력 -->
		     <div class="input-group mb-3">
			  <span class="input-group-text" id="basic-addon1">차시</span>
			  <input type="text" class="form-control" placeholder="차시" id="lesson" aria-label="Username" aria-describedby="basic-addon1">
			</div>
		    <div class="input-group mb-3">
			  <span class="input-group-text" id="basic-addon1">제목</span>
			  <input type="text" class="form-control" placeholder="제목" id="title" aria-label="Username" aria-describedby="basic-addon1">
			</div>
		    <div class="input-group mb-3">
			  <span class="input-group-text" id="basic-addon1">설명</span>
			  <input type="text" class="form-control" placeholder="설명" id="explain"  aria-label="Username" aria-describedby="basic-addon1">
			</div>
		    <div class="input-group mb-3">
			  <span class="input-group-text" id="basic-addon1">파일</span>
			  <input type="file" class="form-control" placeholder="첨부파일" id="fileNm" aria-label="Username" aria-describedby="basic-addon1"/>
			  <input type="button" value="+" class="btn btn-dark btn-sm" id="add" />
			  <input type="button" value="-" class="btn btn-light btn-sm" id="delete" />
			</div> 
	    ...
	    <!-- 강의 차시 -->
	    <input type="text" readonly class="form-control-plaintext" value="강의목차" />
	    ...
	    <div style="text-align: center;">
		    ...
		    <input type="button" value="취소" class="btn btn-light btn-sm" id="cancleBtn"/>
	    </div>
